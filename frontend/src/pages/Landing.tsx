...
export const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-nude-50 via-cream-50 to-sand-50">
      ...
      <div className="container mx-auto px-4 py-16 lg:py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-nude-900 mb-6 leading-tight">
            ...
            <span className="bg-gradient-to-r from-sand-600 to-nude-600 bg-clip-text text-transparent">guided AI counsellor</span>
          </h1>
      ...
      <div className="bg-gradient-to-br from-nude-900 via-sand-900 to-nude-800 py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-nude-800/50 to-sand-800/50 backdrop-blur-sm border border-sand-600/30 p-6 rounded-xl hover:border-sand-400/50 transition-all duration-300">
              <div className="w-14 h-14 bg-gradient-to-br from-sand-500 to-sand-600 rounded-lg flex items-center justify-center mb-4">
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-nude-900 mb-4">
              Your Journey in 4 Simple Stages
            </h2>
            <p className="text-nude-600 text-lg max-w-2xl mx-auto">
          ...
          <div className="relative">
            {/* Connection line */}
            <div className="hidden lg:block absolute top-1/4 left-0 right-0 h-1 bg-gradient-to-r from-sand-200 via-sand-300 to-sand-200" style={{transform: 'translateY(-50%)'}}></div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
              {[
                ...
                <div key={item.step} className="text-center relative z-10">
                  <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-sand-600 to-nude-600 rounded-full text-white font-bold text-2xl mb-4 shadow-lg relative">
                    <div className="absolute inset-0 bg-gradient-to-br from-sand-400 to-nude-400 rounded-full animate-pulse opacity-50"></div>
                    <span className="relative z-10">{item.step}</span>
                  </div>
                  <div className="bg-white p-6 rounded-xl shadow-soft border border-nude-100 min-h-[180px]">
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-sand-700 to-nude-700 rounded-3xl p-12 md:p-16 text-center shadow-xl">
            ...
            <div className="flex justify-center">
              <Link to="/signup">
                <Button
                  variant="secondary"
                  size="lg"
                  className="bg-white text-sand-800 hover:bg-nude-50 font-semibold px-10 py-4 text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                >
                  Get Started Now
                </Button>
              </Link>
